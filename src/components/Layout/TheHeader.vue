<template>
    <header class="px-5 py-5 sticky top-0 w-full flex justify-between items-center bg-white">
        ...
        <div class="relative hidden md:block">
            ...
            <input type="text" name="search" id="search" class="bg-primary text-[#fefefe] focus:border-none focus:outline-none pl-8 px-4 py-1 box-border w-44 rounded-3xl" autocomplete="off">
        </div>
    </header>
</template>
