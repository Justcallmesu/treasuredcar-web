<template>
    <div class="py-10 pb-20 px-5 pt-[8rem] relative overflow-x-hidden text-white bg-[url('/public/img/Home/heroimg.jpg')] bg-cover min-h-screen flex flex-col bg-no-repeat md:block">
